...
public class FileSystem {
	...
	public static void changeDirectory(String d){
		...
		if( temp!= null && temp.getKind().equals("Directory"))
			...
			System.out.println("Invalid Directory" +" <" +d.toString() + "> ");
	}
	public static void changeDirectoryAbsolute(String d){
		
		FSElement temp =root.findByNameRecursive(d.toString()) ;
		if( temp!= null && temp.getKind().equals("Directory"))
			currentDirectory = (Directory) temp ;
		else
			System.out.println("Invalid Directory" +" <" +d.toString() + "> ");
	...
	public static void renameDirectory(String previousSelected) {
		currentDirectory.rename(previousSelected);
		// TODO Auto-generated method stub
